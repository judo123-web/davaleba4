            ...
            <div class="grid grid-cols-1 md:grid-cols-2" style="margin: 20px">
                ...
                <form method="POST" action="{{route('store')}}">
                    ...
                    <div class="form-group">
                        ...
                        <input name="author_name" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Author_Name">
                    ...
                    <div class="form-group">
                        ...
                        <input name="post_text" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Post_text">
                        <small id="emailHelp" class="form-text text-muted">Post Text</small>
                        @error('post_text')
                        <p style="color: red">{{$errors->first('post_text')}}</p>
                        @enderror
                    </div>
